...
extern void phone_sync_sys_vol_handle_register(void (*handle)(u8 vol));
...
extern void bt_set_low_power(u8 type,u32 osc_hz,u8 config,u8 is_use_PR,u8 delay_us,u8 d2sh_dis_sw,void (*fun)(void));
#endif
